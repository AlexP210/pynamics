...
class TestDynamics(unittest.TestCase):
    ...
    def test_buoyancy(self):
        ...
        self.save_plot_artifact(
            ...
            value_name="Z Position", test_name="test_buoyancy"
        )
        self.assertTrue(
    ...
    def test_gravity(self):
        ...
        self.save_plot_artifact(
            time=t, value=x, expected_value=x_expected,
            value_name="Z Position", test_name="test_gravity"
        )
    ...
    def test_drag(self):
        ...
        v = sim.data_history[f"Cube / Velocity 3"]

        self.save_plot_artifact(
            time=t, value=v, expected_value=v_expected,
            value_name="X Velocity", test_name="test_drag"
        )
